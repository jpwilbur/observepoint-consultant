...
Government's regulatory exposure is dominated by **accessibility**, with a thin privacy layer on top for state/local bodies. Do not restate effective dates or enforcement detail — the accessibility audit motion lives in `references/privacy-and-compliance.md` → Accessibility (WCAG 2.1 AA / European Accessibility Act).
