...
- **FERPA** protects student education records — identifiable student data cannot flow to third parties without consent. A tracking pixel on a student portal that ships an identifiable student value to an ad vendor is the FERPA fact pattern. See the **privacy-compliance** skill, FERPA.
- **State student-data-privacy laws (SOPIPA-style).** 30+ states (California's SOPIPA being the model) bar edtech vendors from using student data for advertising, building student profiles, or selling student data. See the **privacy-compliance** skill, State student data privacy laws.
- **COPPA on under-13s.** Verifiable parental consent before collecting personal information from children under 13, and no behavioral advertising to them — COPPA 2.0 (phasing through 2026) sweeps persistent identifiers into "personal information." See the **privacy-compliance** skill, COPPA.
...
- **FERPA** applies the same as K-12 — the logged-in student experience (registration, grades, financial aid) is education records, and tracking on those pages is the exposure. See the **privacy-compliance** skill, FERPA.
- **AADC on under-18 prospective and incoming students.** Marketing and admissions pages are accessed by minors researching colleges, which pulls the California Age-Appropriate Design Code (where in force — verify the current injunction status) onto the prospect-facing surface. See the **privacy-compliance** skill, California AADC.
- **DOJ Title II accessibility actions (active in 2026).** The 2024 DOJ ADA Title II rule sets WCAG 2.1 AA for public university web content, and enforcement against universities is active through 2026. Course catalogs, application flows, and the logged-in student experience are the high-traffic templates that must conform. The accessibility audit motion is in the **privacy-compliance** skill, Accessibility (WCAG 2.1 AA).
...
Education's exposure layers student-data privacy on top of accessibility. Do not restate effective dates or enforcement detail — those live in the **privacy-compliance** skill:

- **FERPA**, **COPPA / COPPA 2.0**, **California AADC**, and **state student data privacy laws** — see the named sections in the **privacy-compliance** skill.
- **Accessibility (WCAG 2.1 AA / EAA)** — the Section 508 / DOJ Title II target is WCAG 2.1 AA; see the **privacy-compliance** skill, Accessibility, for the regulation-to-coverage mapping and effective dates, and the **accessibility** skill for the impact-prioritization model, the violation-remediation catalog, and how the accessibility scan and reports work.
