...
1. Load `skills/observepoint-consultant/references/accessibility-playbooks.md`.
...
Do not fabricate accessibility findings. Explain that pulling live issues requires the MCP server, then walk through the manual version (which accessibility reports to open in-app) and the impact-prioritization framework the ranking would apply. Cite `references/accessibility-playbooks.md`.
