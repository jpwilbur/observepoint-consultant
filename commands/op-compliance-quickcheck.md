...
1. Load the **regulation** skill and its deep privacy-and-compliance reference.
...
Do not fabricate audit results. Explain that the live lookup requires the MCP server, then provide the knowledge-only mapping: which regulations apply to the URL and the ObservePoint setup that would prove compliance. Cite the **regulation** skill's deep reference.
