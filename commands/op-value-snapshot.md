...
1. Load `skills/observepoint-consultant/references/roi-and-renewal-framing.md`.
...
Do not fabricate usage numbers. Explain that the quantified pull requires the MCP server, then outline the manual version (which usage and issue reports to export) and the ROI framing the snapshot would apply. Cite `references/roi-and-renewal-framing.md`.
